...
const Latestarticle = () => {
    return (
        <div className='py-8 h-fit w-full flex flex-col gap-10 justify-center items-center'>
            <div className='  max-md:text-center flex justify-between items-center max-md:w-4/5 w-4/5 max-md:flex-col max-md:gap-4  '>
            ...
            <div className='  w-full justify-center items-center  flex'>
                <div className='flex max-md:flex-col max-md:gap-8 items-center max-md:w-4/5 w-4/5 justify-between '>
